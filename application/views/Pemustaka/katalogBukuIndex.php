    ...
    <section id="portfolio" class="clearfix">
      ...
      <div class="container">
        ...
        <header class="section-header">
          ...
          <h3 class="section-title">Buku Populer</h3>
        </header>

        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">Populer</li>
              ...
              ?>
                ...
                filter-<?php if($a['klasifikasi'] == 'Children') {echo 'app';} 
                    ...
                    <div class="portfolio-info">
                        ...
                        <div>
                          <div><a class="btn btn-primary" style="background-color: #b13b42; border:none;" href=<?php echo base_url().'index.php/PemustakaCtl/katalogBuku/'.$a['id_buku'];?>>Selengkapnya</a>
                          </div>
                        </div>
                    </div>
                    </div>
